...
const char *gengetopt_args_info_help[] = {
  ...
  "  -s, --size=INT        Tamanho do vetor  (default=`10')",
  "  -t, --target=INT      Valor a ser procurado",
  "  -n, --numthreads=INT  Número de threads a utilizar na busca",
    0
};
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 't':	/* Valor a ser procurado.  */
          ...
          break;
        case 'n':	/* Número de threads a utilizar na busca.  */
