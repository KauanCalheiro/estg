...
const char *gengetopt_args_info_help[] = {
  ...
  "  -n, --size=INT     Número de elementos no vetor  (default=`500')",
  "  -t, --threads=INT  Número de threads de trabalho  (default=`6')",
    0
};
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->size_arg = 500;
  args_info->size_orig = NULL;
  args_info->threads_arg = 6;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVn:t:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'n':	/* Número de elementos no vetor.  */
        
        
          if (update_arg( (void *)&(args_info->size_arg), 
               &(args_info->size_orig), &(args_info->size_given),
              &(local_args_info.size_given), optarg, 0, "500", ARG_INT,
