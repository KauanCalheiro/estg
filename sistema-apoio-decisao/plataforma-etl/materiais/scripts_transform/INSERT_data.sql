DECLARE
  ...
  -- Evita que numa segunda instalação por "sobreposição" (repetir sem remover plataforma primeiro), 
  -- ocorra duplicação de registos nas tabelas T_LOOKUP_* e T_TEL_*
...
BEGIN
   ...
   IF (v_ja_ha_dados = 0) THEN
	  ...
	  INSERT INTO t_lookup_brands (brand_wrong, brand_transformed) VALUES ('Canepina','Campina');
	  INSERT INTO t_lookup_brands (brand_wrong, brand_transformed) VALUES ('Canppina','Campina');
	  INSERT INTO t_lookup_brands (brand_wrong, brand_transformed) VALUES ('Conpal','Compal');
	  INSERT INTO t_lookup_brands (brand_wrong, brand_transformed) VALUES ('Nestun','Nestum');
	  INSERT INTO t_lookup_brands (brand_wrong, brand_transformed) VALUES ('Mimoza','Mimosa');
      INSERT INTO t_lookup_brands (brand_wrong, brand_transformed) VALUES ('Pescanoiva','Pescanova');
      INSERT INTO t_lookup_brands (brand_wrong, brand_transformed) VALUES ('Pescanoivo','Pescanova');
      INSERT INTO t_lookup_brands (brand_wrong, brand_transformed) VALUES ('Riveralves','Riberalves');
      INSERT INTO t_lookup_brands (brand_wrong, brand_transformed) VALUES ('Riber Alves','Riberalves');
      INSERT INTO t_lookup_brands (brand_wrong, brand_transformed) VALUES ('Qingston','Kingston');
      INSERT INTO t_lookup_brands (brand_wrong, brand_transformed) VALUES ('Kingstown','Kingston');
   END IF;
   ...
   IF (v_ja_ha_dados = 0) THEN
        ...
        VALUES (1,null,'SALES_SRC','172.22.21.58','Windows 10','Base de dados operacional da cadeia de lojas SB') RETURNING source_key INTO v_source_1;
        INSERT INTO t_tel_source (source_key,source_file_name,source_database_name,source_host_ip,source_host_os,source_description)
        VALUES (2,'STORES.CSV',null,'172.22.21.58','Windows 10','Ficheiro contendo informação das lojas da cadeia de lojas') RETURNING source_key INTO v_source_2;
		INSERT INTO t_tel_source (source_key,source_file_name,source_database_name,source_host_ip,source_host_os,source_description)
        VALUES (3,'MANAGERS.CSV',null,'172.22.21.58','Windows 10','Ficheiro contendo informação dos gestores das lojas') RETURNING source_key INTO v_source_3;
    END IF;

   -- INSERTING into t_tel_screen
   SELECT COUNT(*) INTO v_ja_ha_dados FROM t_tel_screen;
   IF (v_ja_ha_dados = 0) THEN
        INSERT INTO t_tel_screen (SCREEN_KEY,SCREEN_NAME,SCREEN_CLASS,SCREEN_DESCRIPTION,SCREEN_VERSION,SCREEN_EXPIRED) values (1,'SCREEN_PRODUCT_DIMENSIONS','CORREÇÃO','Dimensão errada','2.24.0','NO') RETURNING screen_key INTO v_screen_1;
        INSERT INTO t_tel_screen (SCREEN_KEY,SCREEN_NAME,SCREEN_CLASS,SCREEN_DESCRIPTION,SCREEN_VERSION,SCREEN_EXPIRED) values (2,'SCREEN_PRODUCT_WEIGHT','COMPLETUDE','Peso líquido com problemas','2.24.0','NO') RETURNING screen_key INTO v_screen_2;
        INSERT INTO t_tel_screen (SCREEN_KEY,SCREEN_NAME,SCREEN_CLASS,SCREEN_DESCRIPTION,SCREEN_VERSION,SCREEN_EXPIRED) values (3,'SCREEN_PRODUCT_BRANDS','CORREÇÃO','Marca inexistente','2.24.0','NO') RETURNING screen_key INTO v_screen_3;
   END IF;
